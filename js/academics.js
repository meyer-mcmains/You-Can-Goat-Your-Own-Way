$(document).ready(function(){
    ...
    var db;
    var output = "<div class='element %%ID%%'><div class='cont'><div class='imgCont'><img class='pic' src='img/computer.jpg'></div><div class='title'><p class='name'>%%DEPARTMENT%%</p></div><div class='carrot' data-carrot='false' id='4'>></div></div><div class='desc' id='%%ID%%'>%%CONTENT%%</div></div>";
