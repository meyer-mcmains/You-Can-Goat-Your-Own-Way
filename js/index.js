$(document).ready(function(){
    ...
    function createDb(tx){
      ...
      tx.executeSql("CREATE TABLE academics(id,department,content)");
    ...
    */
    ...
    function populateAcademicsDb(tx){
      tx.executeSql('INSERT INTO academics VALUES (1, "Computer Science", "Computing is a major in which you do lots of coding and stuff and its really cool and stuff.")');
      tx.executeSql('INSERT INTO academics VALUES (2, "Information Technology", "Information Technology is a major in which you do lots of techy stuff and its really cool and stuff.")');
      tx.executeSql('INSERT INTO academics VALUES (3, "Information Systems", "Information Systems is a major in which you do lots of informative systems stuff and its really cool and stuff.")');
    }

    /* Parameters ID,Name,Field,Content,Image */
    function populateFacultyDb(tx){
      tx.executeSql('INSERT INTO faculty VALUES (1, "Dr. Marty Barett", "Graduate Studies", "Dr. Barret is the best professor there ever was. He teaches Software Engineering and Operation Systems. He is the kind of professor you wanna go get a beer with.", "img/test.jpg")');
    ...
    function populateGraduatesDb(tx){
      ...
      tx.executeSql('INSERT INTO graduates VALUES (2, "Alex Perry", "Graduated in the Fall of 2016 and now works for Eastman.", "img/alex.jpg")');
    }
